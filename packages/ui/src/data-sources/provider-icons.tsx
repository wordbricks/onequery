...
function MotherDuckIcon({ size = 24, ...props }: ProviderIconProps) {
  return (
    <SvgIcon
      {...props}
...
function LinkedInAdsIcon({ size = 24, ...props }: ProviderIconProps) {
  return (
    <SvgIcon
      {...props}
...
export const ProviderIcons = {
  ...
  onepassword: createSimpleProviderIcon(si1password),
