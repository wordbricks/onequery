...
- [ ] [Workstreams D/E — Separate execution paths and declare the runtime bundle](./config-self-host-cleanup/05-workstream-d-separate-execution-paths.md)
...
- give that path one explicit runtime bundle manifest
