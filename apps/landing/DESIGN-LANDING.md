...
<!-- Note: the current apps/landing implementation is a colorful OneQuery CLI marketing page and diverges sharply from the newer Open Agents-inspired direction in DESIGN.md. -->
...
- Much more colorful than the new Open Agents-inspired direction
