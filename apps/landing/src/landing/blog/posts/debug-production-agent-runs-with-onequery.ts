...
export const debugProductionAgentRunsWithOneQueryPost: BlogPost = {
  body: [
    'A production agent run that only says "Failed" is not enough to debug. The useful question is narrower: which runtime emitted the failure, what fields can we filter on, and whether the failure is a code bug, a provider limit, or an operational pattern.',
    "This is where OneQuery changes the shape of the debugging session. The coding agent can inspect production evidence through a bounded data source, keep the source credentials outside its runtime, and turn the evidence into a small code change.",
  ],
  ...
  sections: [
    {
      ...
      imageSrc:
        "/images/blog/debug-production-agent-runs-with-onequery-access-path.png",
      paragraphs: [
      ...
      title: "The Concept: Connect Cloudflare Logs to Codex",
    },
    {
      id: "logs-into-evidence",
      imageAlt:
      ...
      imagePlacement: "after-title",
      imageSrc:
        "/images/blog/debug-production-agent-runs-with-onequery-evidence-loop.png",
      paragraphs: [
      ...
      title: "The Loop: Discover, Filter, Summarize",
    },
    {
      ...
      imagePlacement: "after-title",
      imageSrc:
        "/images/blog/debug-production-agent-runs-with-onequery-root-cause.png",
      paragraphs: [
      ...
      inlineImages: [
        {
          alt: "Codex investigating a production agent run failure with the onequery-cli skill and cloudflare-wordbricks source.",
          beforeParagraphIndex: 1,
          src: "/images/blog/debug-production-agent-runs-with-onequery-codex-screen.png",
        },
      ],
      images: [
        {
          alt: "Codex reporting the production investigation result with a Fireworks API rate limit cause and recent failure summary.",
          src: "/images/blog/debug-production-agent-runs-with-onequery-codex-result.png",
        },
      ],
      title: "Example: Fireworks Rate Limits",
    },
    {
      id: "what-changed",
      paragraphs: [
      ...
      table: {
        headers: ["Change", "Why it mattered"],
        rows: [
          [
            "DEFAULT_AGENT_LLM_MODEL -> Gemini Flash",
            "New runs without an override avoid the Fireworks quota path.",
          ],
          [
            "Model option added to the UI",
            "Operators can choose the same model explicitly instead of relying only on the shared default.",
          ],
          [
            "Truncation policy updated",
            "The type union stays exhaustive when a new model is introduced.",
          ],
          [
            "PR created with auto-merge",
            "The debugging session ended as a reviewable production change, not a loose diagnosis.",
          ],
        ],
      },
    ...
    },
    {
      ...
      title: "The Debugging Loop We Want",
    },
  ],
