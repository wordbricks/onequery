...
description: "How OneQuery gives LLMs a safe, auditable data access layer without handing them raw production credentials."
coverImage:
...
![Diagram contrasting direct LLM access to raw keys and production data with bounded access through OneQuery.](../../assets/blog/llm-safe-data-access-direct-vs-bounded.png)
...
![Diagram showing OneQuery query safety pipeline with source scope, read-only check, single statement enforcement, result window, and audit event.](../../assets/blog/llm-safe-data-access-query-pipeline.png)
...
![Diagram showing OneQuery connector polling over outbound HTTPS while credentials remain inside customer infrastructure.](../../assets/blog/llm-safe-data-access-connector.png)
