...
impl ::buffa::DefaultInstance for DebugInfo {
    fn default_instance() -> &'static Self {
...
impl ::buffa::DefaultInstance for QuotaFailure {
    fn default_instance() -> &'static Self {
...
pub mod quota_failure {
    ...
    impl ::buffa::DefaultInstance for Violation {
        fn default_instance() -> &'static Self {
...
impl ::buffa::DefaultInstance for PreconditionFailure {
    fn default_instance() -> &'static Self {
...
pub mod bad_request {
    ...
    pub struct FieldViolation {
        ...
        pub localized_message: ::buffa::MessageField<super::LocalizedMessage>,
        #[serde(skip)]
        #[doc(hidden)]
        pub __buffa_unknown_fields: ::buffa::UnknownFields,
    }
...
impl ::buffa::DefaultInstance for ResourceInfo {
    fn default_instance() -> &'static Self {
...
impl ::buffa::DefaultInstance for Help {
    fn default_instance() -> &'static Self {
...
pub mod help {
    ...
    impl ::buffa::DefaultInstance for Link {
        fn default_instance() -> &'static Self {
...
impl ::buffa::DefaultInstance for LocalizedMessage {
    fn default_instance() -> &'static Self {
