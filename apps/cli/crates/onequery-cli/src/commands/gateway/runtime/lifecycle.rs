...
use super::super::super::is_process_running;
...
pub(in crate::commands::gateway) fn read_managed_runtime_pid(
...
pub(super) fn runtime_ready_state_reported_during_startup_poll(
    path: &Path,
    expected_pid: u32,
    command_line: &str,
