...
pub(crate) fn pre_main_hardening_linux() {
    ...
    // Some release builds may ignore variables such as LD_PRELOAD, but clear
    // them here for defense in depth.
...
pub(crate) fn pre_main_hardening_macos() {
    ...
    // OneQuery or inherited child processes do not get sprayed into terminal output.
