...
fn runtime_paths_follow_self_host_layout_contract() {
    ...
    let expected = SelfHostRuntimePaths {
        ...
        pid_path: PathBuf::from("/data/onequery/run/server.pid"),
        lock_path: PathBuf::from("/data/onequery/run/server.lock"),
        stop_request_path: PathBuf::from("/data/onequery/run/server.stop"),
        supervisor_pid_path: PathBuf::from("/data/onequery/run/supervisor.pid"),
        supervisor_state_path: PathBuf::from("/data/onequery/run/supervisor.state.json"),
