...
- [better-result](https://github.com/dmmulroy/better-result) by [Dillon Mulroy](https://x.com/dillon_mulroy): Forces every failure to be handled explicitly, so errors never silently slip through.
- [antiox](https://github.com/rivet-dev/antiox) by [Rivet](https://rivet.dev/): Keeps concurrent queries, timeouts, and cancellations predictable, with no leaked tasks or hanging connections.
...
- [connect-rust](https://github.com/anthropics/connect-rust) by [Anthropic](https://www.anthropic.com/): Provides Tower-based Rust Connect RPC support across Connect, gRPC, and gRPC-Web.
